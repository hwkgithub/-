<template>
  <div class="shop-header">
    ...
    <!-- 商家优惠活动 -->
    <!-- 
    出现说xxx of undefined时 是因为页面刚开始是显示初始数据而这个时候Info是空的
    所以info.supports[0]的话supports是空的而这个数组没有下标为0的值
    而我的模块里面直接显示3层表达式，解决办法是加个v-if
    只要加个v-if="info.supports"当Info有值的时候才有这个div
    -->
    <div class="shop-header-discounts"
         v-if="info.supports"
         @click="toggleSupportShow">
      <div class="discounts-left">
        <!-- 把样式放在数组里面根据后台的type值来更换样式 -->
        <div class="activity"
